...
import 'package:scube_task_app/screens/listitem_details_screen/listitem_details_screen.dart';
...
List<GetPage> appRootRoutesFile = <GetPage>[
  ...
  GetPage(
    name: AppRoutes.instance.listItemDetailsScreen,
    binding: AllBinding(),
    page: () => const ListItemDetailsScreen(),
  ),
];
